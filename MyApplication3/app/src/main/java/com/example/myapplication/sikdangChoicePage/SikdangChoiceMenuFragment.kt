...
//프래그먼트에 바인드하는 클래스
class SikdangChoiceMenuFragment(var sikdangImage : Int, sikdangName : String, val repMenuArrayList:ArrayList<String>, val anyList:ArrayList<Int>) :Fragment() {
    ...
    fun bind(itemView:View):View?{
        ...
        var sikdangChoiceMenuAdapter = SikdangChoiceMenuAdapter(this!!.getActivity()!!)
